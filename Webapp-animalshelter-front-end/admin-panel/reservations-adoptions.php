...
<head>
    ...
    <title>Reservations & Adoptions | AS</title>
...
<div class="main-wrapper">
    <section class="sub-wrapper">
        <aside class="sidebar">
            ...
            <a href="reservations-adoptions.php" class="links active"><i class="fa fa-hand-paper-o" aria-hidden="true"></i>Reservations & Adoptions</a>
        ...
        <div class="content-wrapper">
            <h3 class="title">Reservation and Adoption Records</h3>

            <div class="content-bar">
                <div class="left-side"> <label class="labelfor">RESERVATION RECORDS</label></div>
            ...
            <div class="table-container">
                <table class="tablefor" id="animals-tb">
                    ...
                    <tbody>
                        <tr>
                            <td class="a-name-col">Name</td>
                            <td class="">Animal</td>
                            <td class="">Reservation Date</td>
                            <td class="">Pickup Date</td>
                            <td class="">
                                <form method="post">
                                    <button type="submit">ADOPTED</button>
                                </form>
                            </td>
            ...
            <!-- Adoptions Table -->
            <div class="content-bar">
                <div class="left-side"> <label class="labelfor">ADOPTION RECORDS</label></div>
