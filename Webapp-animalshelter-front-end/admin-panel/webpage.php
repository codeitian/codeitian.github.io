...
<head>
    ...
    <title>Webpage Management | AS</title>
...
<div class="main-wrapper">
    <section class="sub-wrapper">
        <aside class="sidebar">
            ...
            <a href="webpage.php" class="links active"><i class="fa fa-globe" aria-hidden="true"></i>Webpage Management</a>
        ...
        <div class="content-wrapper">
            <h3 class="title">WEBPAGE MANAGEMENT</h3>
